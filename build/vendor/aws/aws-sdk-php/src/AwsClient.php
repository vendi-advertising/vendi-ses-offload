...
use Vendi\SesOffload\Vendor\Aws\Auth\AuthSelectionMiddleware;
use Vendi\SesOffload\Vendor\Aws\Auth\AuthSchemeResolverInterface;
use Vendi\SesOffload\Vendor\Aws\EndpointDiscovery\EndpointDiscoveryMiddleware;
use Vendi\SesOffload\Vendor\Aws\EndpointV2\EndpointProviderV2;
use Vendi\SesOffload\Vendor\Aws\EndpointV2\EndpointV2Middleware;
...
class AwsClient implements AwsClientInterface
{
    ...
    private function loadAliases($file = null)
    {
        if (!isset($this->aliases)) {
            ...
            $aliases = \Vendi\SesOffload\Vendor\Aws\load_compiled_json($file);
    ...
    {
        $this->getHandlerList()->appendInit(function (callable $handler) {
    ...
    {
        $aliases = \Vendi\SesOffload\Vendor\Aws\load_compiled_json(__DIR__ . '/data/aliases.json');
