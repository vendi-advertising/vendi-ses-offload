...
use Vendi\SesOffload\Vendor\Aws\Signature\SignatureV4;
...
class PresignUrlMiddleware
{
    ...
    private function createPresignedUrl(AwsClientInterface $client, CommandInterface $cmd)
    {
        ...
        $request = \Vendi\SesOffload\Vendor\Aws\serialize($newCmd);
        // Create the new endpoint for the target endpoint.
        if ($this->endpointProvider instanceof \Vendi\SesOffload\Vendor\Aws\EndpointV2\EndpointProviderV2) {
