...
namespace Vendi\SesOffload\Vendor\Aws\Sts\RegionalEndpoints;

use Vendi\SesOffload\Vendor\Aws\AbstractConfigurationProvider;
use Vendi\SesOffload\Vendor\Aws\CacheInterface;
use Vendi\SesOffload\Vendor\Aws\ConfigurationProviderInterface;
use Vendi\SesOffload\Vendor\Aws\Sts\RegionalEndpoints\Exception\ConfigurationException;
...
class ConfigurationProvider extends AbstractConfigurationProvider implements ConfigurationProviderInterface
{
    ...
    public static function ini($profile = null, $filename = null)
    {
        ...
        return function () use ($profile, $filename) {
            ...
            $data = \Vendi\SesOffload\Vendor\Aws\parse_ini_file($filename, \true);
            if ($data === \false) {
