...
use Vendi\SesOffload\Vendor\Aws\LruArrayCache;
...
use Vendi\SesOffload\Vendor\GuzzleHttp\Psr7\Stream;
...
class StreamWrapper
{
    ...
    public function dir_opendir($path, $options)
    {
        ...
        $this->objectIterator = \Vendi\SesOffload\Vendor\Aws\flatmap($this->getClient()->getPaginator('ListObjects', $op), function (Result $result) use ($filterFn) {
