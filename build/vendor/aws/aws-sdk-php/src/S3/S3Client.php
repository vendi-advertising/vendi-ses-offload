...
use Vendi\SesOffload\Vendor\Aws\Api\DocModel;
use Vendi\SesOffload\Vendor\Aws\Api\Service;
use Vendi\SesOffload\Vendor\Aws\AwsClient;
use Vendi\SesOffload\Vendor\Aws\CacheInterface;
use Vendi\SesOffload\Vendor\Aws\ClientResolver;
use Vendi\SesOffload\Vendor\Aws\Command;
...
use Vendi\SesOffload\Vendor\Aws\HandlerList;
use Vendi\SesOffload\Vendor\Aws\Identity\S3\S3ExpressIdentityProvider;
use Vendi\SesOffload\Vendor\Aws\InputValidationMiddleware;
use Vendi\SesOffload\Vendor\Aws\Middleware;
use Vendi\SesOffload\Vendor\Aws\ResultInterface;
use Vendi\SesOffload\Vendor\Aws\Retry\QuotaManager;
use Vendi\SesOffload\Vendor\Aws\RetryMiddleware;
use Vendi\SesOffload\Vendor\Aws\RetryMiddlewareV2;
use Vendi\SesOffload\Vendor\Aws\S3\Parser\GetBucketLocationResultMutator;
use Vendi\SesOffload\Vendor\Aws\S3\Parser\S3Parser;
use Vendi\SesOffload\Vendor\Aws\S3\Parser\ValidateResponseChecksumResultMutator;
use Vendi\SesOffload\Vendor\Aws\S3\RegionalEndpoint\ConfigurationProvider;
use Vendi\SesOffload\Vendor\Aws\S3\UseArnRegion\Configuration;
use Vendi\SesOffload\Vendor\Aws\S3\UseArnRegion\ConfigurationInterface;
use Vendi\SesOffload\Vendor\Aws\S3\UseArnRegion\ConfigurationProvider as UseArnRegionConfigurationProvider;
...
class S3Client extends AwsClient implements S3ClientInterface
{
    ...
    public function createPresignedRequest(CommandInterface $command, $expires, array $options = [])
    {
        ...
        $request = \Vendi\SesOffload\Vendor\Aws\serialize($command);
    ...
    public function getObjectUrl($bucket, $key)
    {
        ...
        return (string) \Vendi\SesOffload\Vendor\Aws\serialize($command)->getUri();
    }
    /**
    ...
    {
        if ($value) {
            $config = \Vendi\SesOffload\Vendor\Aws\Retry\ConfigurationProvider::unwrap($value);
