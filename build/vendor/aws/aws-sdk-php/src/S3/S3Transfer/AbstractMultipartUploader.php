...
use Vendi\SesOffload\Vendor\Aws\CommandPool;
...
abstract class AbstractMultipartUploader implements PromisorInterface
{
     ...
     */
    public function __construct(S3ClientInterface $s3Client, array $requestArgs, array $config = [], ?string $uploadId = null, array $partsCompleted = [], ?TransferProgressSnapshot $currentSnapshot = null, ?TransferListenerNotifier $listenerNotifier = null)
    {
     ...
     * @return void
     */
    abstract protected function partCompleted(int $partSize, array $requestArgs, array $partData): void;
    /**
     * @return PromiseInterface
     */
     ...
     * @return array
     */
    protected function collectPart(ResultInterface $result, CommandInterface $command): array
    {
        ...
        $partData = ['PartNumber' => $partNumber, 'ETag' => $checksumResult['ETag']];
