...
final class ResumeDownloadRequest
{
     ...
     */
    public function __construct(string|ResumableDownload $resumableDownload, string $downloadHandlerClass = FileDownloadHandler::class, array $listeners = [], ?AbstractTransferListener $progressTracker = null)
    {
