...
final class DownloadDirectoryRequest extends AbstractTransferRequest
{
     ...
     */
    public function __construct(string $sourceBucket, string $destinationDirectory, array $downloadRequestArgs = [], array $config = [], array $listeners = [], ?AbstractTransferListener $progressTracker = null, array $singleObjectListeners = [])
    {
        parent::__construct($listeners, $progressTracker, $config, $singleObjectListeners);
