...
final class UploadDirectoryRequest extends AbstractTransferRequest
{
     ...
     */
    public function __construct(string $sourceDirectory, string $targetBucket, array $uploadRequestArgs = [], array $config = [], array $listeners = [], ?AbstractTransferListener $progressTracker = null, array $singleObjectListeners = [])
    {
