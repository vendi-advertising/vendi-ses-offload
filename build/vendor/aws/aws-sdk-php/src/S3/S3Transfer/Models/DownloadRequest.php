...
use Vendi\SesOffload\Vendor\Aws\S3\S3Transfer\S3TransferManager;
...
{
    public static array $configKeys = ['response_checksum_validation' => 'string', 'multipart_download_type' => 'string', 'track_progress' => 'bool', 'concurrency' => 'int', 'resume_enabled' => 'bool', 'resume_file_path' => 'string', 'target_part_size_bytes' => 'int'];
     ...
     */
    public function __construct(string|array|null $source, array $downloadRequestArgs = [], array $config = [], ?AbstractDownloadHandler $downloadHandler = null, array $listeners = [], ?AbstractTransferListener $progressTracker = null)
    {
