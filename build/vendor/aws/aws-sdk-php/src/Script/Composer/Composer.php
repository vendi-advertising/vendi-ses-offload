...
namespace Vendi\SesOffload\Vendor\Aws\Script\Composer;

use Vendi\SesOffload\Vendor\Composer\Script\Event;
use Vendi\SesOffload\Vendor\Symfony\Component\Filesystem\Exception\IOException;
use Vendi\SesOffload\Vendor\Symfony\Component\Filesystem\Filesystem;
class Composer
{
    private static array $unsafeForDeletion = ['Kms' => \true, 'S3' => \true, 'SSO' => \true, 'SSOOIDC' => \true, 'Sts' => \true, 'Signin' => \true];
