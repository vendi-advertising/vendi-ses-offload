...
use Vendi\SesOffload\Vendor\Aws\Credentials\CredentialSources;
use Vendi\SesOffload\Vendor\Aws\Token;
...
final class MetricsBuilder
{
    ...
    private function appendRetryConfigMetric(array $args): void
    {
        ...
        $retryMode = '';
        if ($retries instanceof \Vendi\SesOffload\Vendor\Aws\Retry\Configuration) {
