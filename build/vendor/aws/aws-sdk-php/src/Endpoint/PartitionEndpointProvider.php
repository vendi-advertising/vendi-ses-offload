...
namespace Vendi\SesOffload\Vendor\Aws\Endpoint;

use Vendi\SesOffload\Vendor\JmesPath\Env;
class PartitionEndpointProvider
{
    ...
    {
        $data = \Vendi\SesOffload\Vendor\Aws\load_compiled_json(__DIR__ . '/../data/endpoints.json');
        $prefixData = \Vendi\SesOffload\Vendor\Aws\load_compiled_json(__DIR__ . '/../data/endpoints_prefix_history.json');
