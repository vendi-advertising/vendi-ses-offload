...
namespace Vendi\SesOffload\Vendor\Aws\Cbor;

use Vendi\SesOffload\Vendor\Aws\Cbor\Exception\CborException;
/**
            ...
            case 7:
                ...
                switch ($info) {
                    ...
                    case 25:
                        ...
                        $mant = $half & 0x3ff;
                        if ($exp === 0) {
                            return $mant === 0 ? $sign ? -0.0 : 0.0 : ($sign ? -1 : 1) * pow(2, -14) * ($mant / 1024);
                        }
                        if ($exp === 31) {
