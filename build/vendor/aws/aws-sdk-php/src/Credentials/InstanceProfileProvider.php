...
namespace Vendi\SesOffload\Vendor\Aws\Credentials;

use Vendi\SesOffload\Vendor\Aws\Configuration\ConfigurationResolver;
use Vendi\SesOffload\Vendor\Aws\Exception\CredentialsException;
use Vendi\SesOffload\Vendor\Aws\Exception\InvalidJsonException;
use Vendi\SesOffload\Vendor\Aws\Sdk;
use Vendi\SesOffload\Vendor\GuzzleHttp\Exception\TransferException;
...
class InstanceProfileProvider
{
    ...
    public function __construct(array $config = [])
    {
        ...
        $this->client = $config['client'] ?? \Vendi\SesOffload\Vendor\Aws\default_http_handler();
    ...
    private function request($url, $method = 'GET', $headers = [])
    {
        ...
        $userAgent .= ' ' . \Vendi\SesOffload\Vendor\Aws\default_user_agent();
    ...
    {
        $isImdsV1Disabled = \Vendi\SesOffload\Vendor\Aws\boolean_value($this->ec2MetadataV1Disabled) ?? \Vendi\SesOffload\Vendor\Aws\boolean_value(ConfigurationResolver::resolve(self::CFG_EC2_METADATA_V1_DISABLED, self::DEFAULT_AWS_EC2_METADATA_V1_DISABLED, 'bool', $this->config)) ?? self::DEFAULT_AWS_EC2_METADATA_V1_DISABLED;
