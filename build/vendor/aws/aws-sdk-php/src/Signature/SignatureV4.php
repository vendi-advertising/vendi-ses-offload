...
use Vendi\SesOffload\Vendor\AWS\CRT\Auth\Signable;
use Vendi\SesOffload\Vendor\AWS\CRT\Auth\SignatureType;
use Vendi\SesOffload\Vendor\AWS\CRT\Auth\SignedBodyHeaderType;
use Vendi\SesOffload\Vendor\AWS\CRT\Auth\Signing;
use Vendi\SesOffload\Vendor\AWS\CRT\Auth\SigningAlgorithm;
use Vendi\SesOffload\Vendor\AWS\CRT\Auth\SigningConfigAWS;
use Vendi\SesOffload\Vendor\AWS\CRT\Auth\StaticCredentialsProvider;
use Vendi\SesOffload\Vendor\AWS\CRT\HTTP\Request;
use Vendi\SesOffload\Vendor\Aws\Exception\CommonRuntimeException;
use Vendi\SesOffload\Vendor\Aws\Exception\CouldNotCreateChecksumException;
...
{
    use SignatureTrait;
    const ISO8601_BASIC = 'Vendi\SesOffload\Vendor\Ymd\THis\Z';
