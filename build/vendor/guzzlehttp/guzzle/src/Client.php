...
use Vendi\SesOffload\Vendor\GuzzleHttp\Cookie\CookieJar;
use Vendi\SesOffload\Vendor\GuzzleHttp\Exception\GuzzleException;
 ...
 * @final
 */
class Client implements ClientInterface, \Vendi\SesOffload\Vendor\Psr\Http\Client\ClientInterface
{
    use ClientTrait;
    /**
